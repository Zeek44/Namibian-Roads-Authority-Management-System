...
const DeviceErrorBoundary = ({
  ...
  return (
    <SharedErrorBoundary
      ...
      description={
        sentLogs
          ? 'It looks like an error occurred while trying to use your app. This error has been reported to the AI agent and should be visible to the AI soon. If it is not present please see GUESS VERIFIED Team'
          : 'It looks like an error occurred while trying to use your app. Please see GUESS VERIFIED Team for help'
      }
    >
